...
<body>
    ...
    <form class="col s12" id="registro" name="registro" action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
      ...
      <div class="row">
        ...
        <form action="#">
            <p>
                <input class="with-gap" name="group1" name="tipo_usuario" id="idtipo_usuario" type="radio" value="2" />
                <label for="idtipo_usuario">Usuario</label>
            </p>
            <p>
                <input class="with-gap" name="group1" name="tipo_usuario" id="idtipo_usuario" type="radio" value="1" checked/>
